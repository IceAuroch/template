                ...
                <nav class="menu justify-content-center align-items-center">
                    <ul class="menu-list list-unstyled d-flex flex-column flex-lg-row justify-content-between align-items-center">
                        <li class="menu-list-item">
                            <a href="#seminar" class="menu-list-item__link scroll-link">
                                О семинаре
                            </a>
                        </li>

                        <li class="menu-list-item">
                            <a href="#for-who" class="menu-list-item__link scroll-link">
                                Для кого семинар
                            </a>
                        </li>
                        ...
                        <li class="menu-list-item">
                            <a href="#programm" class="menu-list-item__link scroll-link">
                                Программа
                            </a>
                        </li>

                        <li class="menu-list-item">
                            <a href="#format" class="menu-list-item__link scroll-link">
                                Форматы участия
                            </a>
                        </li>
